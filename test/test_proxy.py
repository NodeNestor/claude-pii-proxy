...
SAMPLE = (
    "Hi, my name is NodeNestor and you can reach me at "
    "redacted@users.noreply.github.com or call +46 70 123 45 67. "
    "Thanks!"
)
...
def run_case(label: str, stream: bool):
    ...
    pii_substrings = ["nestor", "Redacted", "redacted@users.noreply.github.com", "+46 70 123 45 67"]
    ...
    assert_("nestor" in text, "client response contains restored 'nestor'")
    # Email may be partially detected; check at least the local part survives if email was tokenised.
    assert_("NodeNestor" in text or "@gmail.com" in text or "name-" in text and "email-" not in text,
