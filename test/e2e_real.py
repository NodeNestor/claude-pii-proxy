...
def main():
    ...
    try:
        ...
        prompt = (
            ...
            "'My name is NodeNestor and you can email me at "
            "redacted@users.noreply.github.com.'"
        )
        print(f"\n[TEST] prompt: {prompt}\n")
        ...
        contains_real = "nestor" in result.stdout
        ...
        for cond, label in [
            ...
            (contains_real, "client output contains restored 'nestor'"),
