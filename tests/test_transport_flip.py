...
def run_wire(env, live, force=False):
    ...
    with tempfile.TemporaryDirectory() as d:
        ...
        sys.argv = ["wire.py", "--name", "pii-proxy",
...
# pii-proxy: core 5599, MITM 5601.
PRE_113 = {"ANTHROPIC_BASE_URL": "http://127.0.0.1:5599"}
CA = "/home/u/.claude/proxy-ca/ca-cert.pem"
WIRED_113 = {"HTTPS_PROXY": "http://127.0.0.1:5601", "NODE_EXTRA_CA_CERTS": CA}
...
def test_wire():
    ...
    check(env.get("ANTHROPIC_BASE_URL") == "http://127.0.0.1:5599",
    ...
    check(env.get("HTTPS_PROXY") == "http://127.0.0.1:5601",
    ...
    check(wire._reaches_via_our_mitm(WIRED_113, 5601) is True, "predicate: wired reaches mitm")
    check(wire._reaches_via_our_mitm(PRE_113, 5601) is False, "predicate: pre-1.13 does not")
    check(wire._reaches_via_our_mitm({"HTTPS_PROXY": "http://127.0.0.1:5601"}, 5601) is False,
